...
public class SmsUtils {
    public static void sendSms(Context context, String sendTo, String content, int slot, int subId) {
    ...
    public static void sendFallbackSms(Context context, String content, int subId) {
